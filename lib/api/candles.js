...
module.exports = function (app) {
    ...
    var bittrex = new candles.bittrex(app.locals.redis);
        ...
        function (err, results) {
            if (err) {
                ...
                var statistics = {
                    ...
                    aschVolume : _.reduce(results[0], function (memo, t) { return (memo + parseFloat(t.aschVolume)); }, 0.0).toFixed(8),
                ...
                statistics = {
                    ...
                    aschVolume : statistics.aschVolume,
